...
function iq_bible_api_register_settings()
{
    ...
    register_setting('iq_bible_api_options', 'iq_bible_custom_login_url'); // Register the Custom Login URL setting
}
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <input type="hidden" id="api-key-input" name="iq_bible_api_key" value="<?php echo esc_attr($api_key); ?>" size="60" autocomplete="off" minlength="10" />
